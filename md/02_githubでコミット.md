...
<img width="90%" src="../png/01_repository04.png">

するとこんなページに遷移する。
<img width="90%" src="../png/02_commit01.png">



## 2. READMEに記述する。
md記法で書き込む。解説が必要なら別途。
<img width="60%" src="../png/02_commit02.png">


<details><summary>TIPS</summary>

タブのPreviewを選択すると、書いたmdのレビューができる。編集終える前に一度確認しておくべき。
<img width="60%" src="../png/02_commit02_2.png">
...
<div>
<img width="70%" src="../png/02_commit03.png">
...
<img width="70%" src="../png/02_commit04.png">
...
<img width="90%" src="../png/02_commit05.png"><br/>


コミット内容は右上の時計っぽいボタンから確認できる。  

さっきのコミットメッセージはこんな感じ。
<img width="60%" src="../png/02_commit06.png">
